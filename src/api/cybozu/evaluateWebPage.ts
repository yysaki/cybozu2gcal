...
export type EvaluateWebPage = () => Promise<EvaluateOutputData[]>;
...
const evaluate = async (page: Page): Promise<EvaluateOutputData[]> => {
...
export const evaluateWebPage: EvaluateWebPage = async () => {
